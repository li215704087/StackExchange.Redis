...
namespace StackExchange.Redis.Helper
{
    public class CacheManager:ICacheManager
    {
        ...
        private string SysCustomKey { get; }
        ...
        public CacheManager(IOptions<RedisConfigOption> redisConfigOption)
        {
            ...
            _conn = RedisConnectionHelper.Instance(redisConnectionString) ?? RedisConnectionHelper.CreateConnect(_configurationOptions);

            DbNum = _redisConfigOption.DefaultDb;
            SysCustomKey = _redisConfigOption.SysCustomKey;
        }
